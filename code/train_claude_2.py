import torch
from claude_model_NIR_2 import EuclidToJWSTSuperResolution, EuclidToJWSTDataset, train_two_stage
...
torch.save(trained_model.state_dict(), 'models/claude_model_NIR_2stage.pth')
