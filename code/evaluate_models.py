...
from diffusion.model_sr3 import SuperResDiffusionUNet, Upsampler, SuperResolutionDiffusion
...
def get_val_dataset():
    ...
    print(f"Validation set: {val_size} samples (seed={SEED})")
    return val_dataset
...
def load_diffusion_model():
    unet  = SuperResDiffusionUNet(in_channels=1, out_channels=1, hidden_dim=DIFF_HIDDEN_DIM)
    upsampler = Upsampler(in_channels=1, out_channels=1)
